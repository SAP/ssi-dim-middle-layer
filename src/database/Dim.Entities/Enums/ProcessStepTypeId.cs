...
public enum ProcessStepTypeId
{
    ...
    GET_TECHNICAL_USER_SERVICE_KEY = 102,
    SEND_TECHNICAL_USER_CREATION_CALLBACK = 103,
    RETRIGGER_CREATE_TECHNICAL_USER = 104,
    RETRIGGER_GET_TECHNICAL_USER_DATA = 105,
    RETRIGGER_GET_TECHNICAL_USER_SERVICE_KEY = 106,
    RETRIGGER_SEND_TECHNICAL_USER_CREATION_CALLBACK = 107,
