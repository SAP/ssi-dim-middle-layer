...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.Framework.Processes.Library.Concrete.Entities.ProcessStep<Dim.Entities.Entities.Process, Dim.Entities.Enums.ProcessTypeId, Dim.Entities.Enums.ProcessStepTypeId>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.Framework.Processes.Library.Concrete.Entities.ProcessStepStatus<Dim.Entities.Entities.Process, Dim.Entities.Enums.ProcessTypeId, Dim.Entities.Enums.ProcessStepTypeId>", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.Framework.Processes.Library.Concrete.Entities.ProcessStepType<Dim.Entities.Entities.Process, Dim.Entities.Enums.ProcessTypeId, Dim.Entities.Enums.ProcessStepTypeId>", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.Framework.Processes.Library.Concrete.Entities.ProcessType<Dim.Entities.Entities.Process, Dim.Entities.Enums.ProcessTypeId>", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Dim.Entities.Entities.Process", b =>
                {
                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.Framework.Processes.Library.Concrete.Entities.ProcessType<Dim.Entities.Entities.Process, Dim.Entities.Enums.ProcessTypeId>", "ProcessType")
                        .WithMany("Processes")
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.Framework.Processes.Library.Concrete.Entities.ProcessStep<Dim.Entities.Entities.Process, Dim.Entities.Enums.ProcessTypeId, Dim.Entities.Enums.ProcessStepTypeId>", b =>
                {
                    ...
                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.Framework.Processes.Library.Concrete.Entities.ProcessStepStatus<Dim.Entities.Entities.Process, Dim.Entities.Enums.ProcessTypeId, Dim.Entities.Enums.ProcessStepTypeId>", "ProcessStepStatus")
                        .WithMany("ProcessSteps")
                        .HasForeignKey("ProcessStepStatusId")
                        .IsRequired()
                        .HasConstraintName("fk_process_steps_process_step_statuses_process_step_status_id");

                    b.HasOne("Org.Eclipse.TractusX.Portal.Backend.Framework.Processes.Library.Concrete.Entities.ProcessStepType<Dim.Entities.Entities.Process, Dim.Entities.Enums.ProcessTypeId, Dim.Entities.Enums.ProcessStepTypeId>", "ProcessStepType")
                        .WithMany("ProcessSteps")
