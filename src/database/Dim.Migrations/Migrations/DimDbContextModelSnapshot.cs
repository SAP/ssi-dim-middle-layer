            ...
            modelBuilder.Entity("Dim.Entities.Entities.ProcessStepType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 19,
                            Label = "RETRIGGER_CREATE_SUBACCOUNT"
                        },
                        new
                        {
                            Id = 20,
                            Label = "RETRIGGER_CREATE_SERVICEMANAGER_BINDINGS"
                        },
                        new
                        {
                            Id = 21,
                            Label = "RETRIGGER_ASSIGN_ENTITLEMENTS"
                        },
                        new
                        {
                            Id = 22,
                        ...
                        {
                            Id = 23,
                            Label = "RETRIGGER_CREATE_SERVICE_BINDING"
                        },
                        new
                        {
                            Id = 24,
                            Label = "RETRIGGER_SUBSCRIBE_APPLICATION"
                        },
                        new
                        {
                            Id = 25,
                            Label = "RETRIGGER_CREATE_CLOUD_FOUNDRY_ENVIRONMENT"
                        },
                        new
                        {
                            Id = 26,
                            Label = "RETRIGGER_CREATE_CLOUD_FOUNDRY_SPACE"
                        },
                        new
                        {
                            Id = 27,
                            Label = "RETRIGGER_ADD_SPACE_MANAGER_ROLE"
                        },
                        new
                        {
                            Id = 28,
                            Label = "RETRIGGER_ADD_SPACE_DEVELOPER_ROLE"
                        },
                        new
                        {
                            Id = 29,
                            Label = "RETRIGGER_CREATE_DIM_SERVICE_INSTANCE"
                        },
                        new
                        {
                            Id = 30,
                            Label = "RETRIGGER_CREATE_SERVICE_INSTANCE_BINDING"
                        },
                        new
                        {
                            Id = 31,
                            Label = "RETRIGGER_GET_DIM_DETAILS"
                        },
                        new
                        {
                            Id = 32,
                            Label = "RETRIGGER_CREATE_APPLICATION"
                        },
                        new
                        {
                            Id = 33,
                            Label = "RETRIGGER_CREATE_COMPANY_IDENTITY"
                        },
                        new
                        {
                            Id = 34,
                            Label = "RETRIGGER_ASSIGN_COMPANY_APPLICATION"
                        },
                        new
                        {
                            Id = 35,
            ...
            modelBuilder.Entity("Dim.Entities.Entities.TechnicalUser", b =>
                {
                    b.HasOne("Dim.Entities.Entities.Process", "Process")
                        ...
                        .HasForeignKey("Dim.Entities.Entities.TechnicalUser", "ProcessId")
                        .IsRequired()
            ...
            modelBuilder.Entity("Dim.Entities.Entities.Tenant", b =>
                {
                    b.HasOne("Dim.Entities.Entities.Process", "Process")
                        .WithOne("Tenant")
                        .HasForeignKey("Dim.Entities.Entities.Tenant", "ProcessId")
                        .IsRequired()
